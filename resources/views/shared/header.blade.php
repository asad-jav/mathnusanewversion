    ...
    <div class="navbar-wrapper">
        <div class="navbar-container content">
            <div class="collapse navbar-collapse show" id="navbar-mobile">
                <ul class="nav navbar-nav mr-auto float-left">
                    ...
                    {{-- <li class="dropdown nav-item mega-dropdown d-none d-md-block"><a class="dropdown-toggle nav-link" href="#" data-toggle="dropdown">Mega</a>
                        <ul class="mega-dropdown-menu dropdown-menu row">
                            <li class="col-md-2">
                                ...
                                <ul>
                                    <li><a class="my-1" href="#"><i class="ft-home"></i> Chat</a></li>
                                    <li><a class="my-1" href="#"><i class="ft-grid"></i> Tables</a></li>
                                    <li><a class="my-1" href="#"><i class="ft-bar-chart"></i> Charts</a></li>
                                    <li><a class="my-1" href="#"><i class="ft-sidebar"></i> Gallery</a></li>
                                </ul>
                            </li>
                            <li class="col-md-3">
                                <h6 class="dropdown-menu-header text-uppercase mb-1"><i class="ft-star"></i> My Bookmarks</h6>
                                <ul class="ml-2">
                                    <li class="list-style-circle"><a class="my-1" href="#">
                                            Cards</a></li>
                                    <li class="list-style-circle"><a class="my-1" href="#"> Calender</a></li>
                                    <li class="list-style-circle"><a class="my-1" href="#"> Invoice</a></li>
                                    <li class="list-style-circle"><a class="my-1" href="#"> Contact</a></li>
                                </ul>
                            </li>
                            <li class="col-md-3">
                                ...
                                <div class="carousel slide pt-1" id="carousel-example" data-ride="carousel">
                                    <div class="carousel-inner" role="listbox">
                                        <div class="carousel-item active"><img class="d-block w-100" src="{{ asset('backend/app-assets/images/carousel/08.jpg')}}" alt="First slide"></div>
                                        <div class="carousel-item"><img class="d-block w-100" src="{{ asset('backend/app-assets/images/carousel/03.jpg')}}" alt="Second slide"></div>
                                        <div class="carousel-item"><img class="d-block w-100" src="{{ asset('backend/app-assets/images/carousel/01.jpg')}}" alt="Third slide"></div>
                    ...
                    {{-- <li class="dropdown d-none d-md-block mr-1"><a class="dropdown-toggle nav-link" id="apps-navbar-links" href="#" data-toggle="dropdown">
                        ...
                        <div class="dropdown-menu">
                            <div class="arrow_box"><a class="dropdown-item" href="#"><i class="ft-user"></i> Email</a><a class="dropdown-item" href="#"><i class="ft-mail"></i> Chat</a><a class="dropdown-item" href="#"><i class="ft-briefcase"></i> Project Summary </a><a class="dropdown-item" href="#"><i class="ft-calendar"></i> Calendar </a></div>
                        </div>
                    </li> --}}
                    ...
                    @if (Request::is('class/lecture/*') || Request::is('class/whiteboard/*') && Auth::user()->isAdmin() || Auth::user()->isInstructor()   )
                ...
                @if (Request::is('class/lecture/*')  || Request::is('class/whiteboard/*') )
                &nbsp;
                <span class="navbar-text text-white header-time">
                    <label class="badge badge-primary">Starts At : <b>@yield('start_time')</b></label> 
                    <label class="badge badge-danger">Ends At : <b>@yield('end_time')</b></label>
                </span>
                @endif
                    ...
                    <li class="dropdown dropdown-user nav-item">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown"> 
                            <span class="avatar avatar-online">
                                @if (Auth::user()->avatar != '')
                                    <img src="{{ asset('profile_images/'.Auth::user()->avatar) }}" alt="">
                                    {{-- onerror='this.src="{{ asset('profile_images/dummy-img.png') }}"' --}}
                                @else
                                    <div class="img-box">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            <div class="arrow_box_right">
                                <a class="dropdown-item" href="{{ url('/') }}" target="_blank"><i class="ft-home"></i> Goto Home</a>
                                <a class="dropdown-item" href="{{ url('profile') }}"><i class="ft-user"></i> {{ Auth::user()->first_name }}</a>
