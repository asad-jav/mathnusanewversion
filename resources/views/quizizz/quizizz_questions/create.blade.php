...
@section('title', 'Create New Quiz Question')
@section('css')
<style>
    .btn-primary {
...
<div class="app-content content pt-2 pb-2">
    <div class="col-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form method="Post" action="{{route('quizz-question.store')}}" enctype="multipart/form-data" novalidate>
                    @csrf 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3" id="seconddiv" style="display: none;"> 
                        <div class="customimage"  style="display: none;">
                            ...
                            <img id='img-upload' class="img-upload" style="height: 243px !important;" />
                        ...
                        <div class="customvideo"  style="display: none;">
                            ...
                            <div class="row"> 
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control round @error('question_type') is-invalid @enderror" type="text" name="question_type" id="question_type" required>
                                            <option value="">--Select Question Type--</option>
                                            <option value="1" {{old('question_type') == 1 ? 'selected' : ''}}>Identification</option>
                                            <option value="2" {{old('question_type') == 2 ? 'selected' : ''}}>Multiple Choice</option>
                                            <option value="3" {{old('question_type') == 3 ? 'selected' : ''}}>True or False</option>
                                        </select>
                                        @error('question_type')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control round @error('points') is-invalid @enderror" min="0" type="number" name="points" placeholder="Enter Points" id="points" required>
                                        @error('points')
                                            <span class="text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-actions">
                                <a href="{{url('quizizz',$quizz_id)}}" class="btn btn-danger mr-1 left">
