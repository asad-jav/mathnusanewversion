                            ...
                            <div class="row"> 
                                <div class="col-md-12" >
                                    ...
                                    <div class="form-group">
                                        <textarea class="form-control summernote round" rows="5" type="text" name="quesiton" placeholder="Enter Question" id="question" required>{{old('question',$question->question)}}</textarea>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
