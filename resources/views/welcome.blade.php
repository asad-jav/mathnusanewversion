...
@section('content')
	<div role="main" class="main" id="main">
							...
							<div id="popup-content-1" class="dialog dialog-lg zoom-anim-dialog rounded p-3 mfp-close-out mfp-hide">
								<div class="embed-responsive embed-responsive-4by3">
									<video width="100%" height="100%" autoplay="" muted="" loop="" controls="controls">
											<source src="{{ asset('public/landing-page') }}/video/Intro.mp4" type="video/mp4">
									</video>
								</div>
							</div>
						</div>
				...
				<div class="row">
					<div class="col-lg-4 col-custom-cards ">
						<div class="card border-0 bg-color-dark rounded-0 z-index-1 p-5 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="100">
							<div class="card-body d-flex flex-column justify-content-center align-items-center p-0 my-3">
								<img src="{{ asset('public/landing-page') }}/images/icons/weekly-session-new.svg" alt="Solution" class="mb-5 svg-icon">
					...
					<div class="col-lg-4 col-custom-cards ">
						<div class="card border-0 bg-color-primary rounded-0 z-index-1 p-5 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="200">
							<div class="card-body d-flex flex-column justify-content-center align-items-center p-0 my-3">
								<img src="{{ asset('public/landing-page') }}/images/icons/peer-to-peer.svg" alt="Solution" class="mb-5 svg-icon">
					...
					<div class="col-lg-4 col-custom-cards">
						<div class="card border-0 bg-color-dark rounded-0 z-index-1 p-5 appear-animation" data-appear-animation="maskUp" data-appear-animation-delay="300">
							<div class="card-body d-flex flex-column justify-content-center align-items-center p-0 my-3">
								<img src="{{ asset('public/landing-page') }}/images/icons/gamification.svg" alt="Solution" class="mb-5 svg-icon">
											...
											<div class="row  m-0 isotope-item brand-and-identity content-strategy">
												<div class="col-sm-12 custom-our-work overlay overlay-op-9 p-0">
													<a href="#aboutUs" data-hash="" data-hash-offset="120">
														<img src="{{ asset('public/landing-page') }}/images/our-services/education.jpg" class="img-fluid">
							...
							<div class="row  m-0 isotope-item content-strategy">
								<div class="col-sm-12 custom-our-work overlay overlay-op-9 overlay-show p-0">
									<a href="#" class="d-block">
										<img src="{{ asset('public/landing-page') }}/img/demos/digital-agency-2/bg/bg-8.jpg" class="">
										<div class=" custom-our-work-text p-5 d-flex align-items-end p-absolute bottom-0">
											<div class="text-left p-relative z-index-2 mb-3">
					...
					<div class="row align-items-center justify-content-center pt-5 pb-lg-5">
						<div class="col-md-6 col-xl-6 mb-md-5 mb-xl-4">
							<div class="position-relative">
								<div class="row">
									<div class="col-6">
										<img src="{{ asset('public/landing-page') }}/img/demos/construction-2/about-us/about-girl.png" class="img-fluid custom-img border-radius-0 max-w-90 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="600ms" alt="">
									</div>
									<div class="col-6">
										<img src="{{ asset('public/landing-page') }}/img/demos/construction-2/about-us/about-boy.png" class="img-fluid custom-img border-radius-0 max-w-90 appear-animation" data-appear-animation="fadeIn" data-appear-animation-delay="600ms" alt="" >
									</div>
								</div>
							</div>
						</div>
							...
							<a href="#">
								<span class="thumb-info thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('public') }}/landing-page/images/wall-of-fame/1.jpg" class="img-fluid" alt="">
					...
					<div class="col-md-4 mb-4">
						<div class="portfolio-item">
							<a href="#">
								<span class="thumb-info thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('public') }}/landing-page/images/wall-of-fame/2.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title bg-transparent p-4">
											<span class="thumb-info-inner line-height-1 text-4 font-weight-bold">The Desk</span>
											<span class="thumb-info-type opacity-6">Websites</span>
											<br>
					...
					<div class="col-md-4 mb-4">
						<div class="portfolio-item">
							<a href="#">
								<span class="thumb-info thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('public') }}/landing-page/images/wall-of-fame/3.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title bg-transparent p-4">
											<span class="thumb-info-inner line-height-1 text-4 font-weight-bold">The Desk</span>
											<span class="thumb-info-type opacity-6">Websites</span>
											<br>
					...
					<div class="col-md-4 mb-4">
						<div class="portfolio-item">
							<a href="#">
								<span class="thumb-info thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('public') }}/landing-page/images/wall-of-fame/4.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title bg-transparent p-4">
											<span class="thumb-info-inner line-height-1 text-4 font-weight-bold">The Desk</span>
											<span class="thumb-info-type opacity-6">Websites</span>
											<br>
					...
					<div class="col-md-4 mb-4">
						<div class="portfolio-item">
							<a href="#">
								<span class="thumb-info thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('public') }}/landing-page/images/wall-of-fame/5.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title bg-transparent p-4">
											<span class="thumb-info-inner line-height-1 text-4 font-weight-bold">The Desk</span>
					...
					<div class="col-md-4 mb-4">
						<div class="portfolio-item">
							<a href="#">
								<span class="thumb-info thumb-info-no-borders thumb-info-lighten thumb-info-bottom-info thumb-info-bottom-info-dark thumb-info-bottom-info-show-more thumb-info-no-zoom border-radius-0">
									<span class="thumb-info-wrapper">
										<img src="{{ asset('public') }}/landing-page/images/wall-of-fame/6.jpg" class="img-fluid" alt="">
										<span class="thumb-info-title bg-transparent p-4">
											<span class="thumb-info-inner line-height-1 text-4 font-weight-bold">The Desk</span>
											<span class="thumb-info-type opacity-6">Websites</span>
											<br>
		...
		<section class="get-in-touch bg-color-after-tertiary bg-color-primary p-relative overflow-hidden" style="background-image: url({{ asset('public/landing-page/images/mathnopoly/mathnopoly-3.jpg') }}); background-size:cover">
