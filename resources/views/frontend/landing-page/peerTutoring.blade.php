...
@section('content')
<section class="our-services p-relative py-5 my-5 mt-5" style="background:url('{{ asset('backend/app-assets/images/logo/logo-low-opacity-light.png') }}');background-repeat: no-repeat;background-attachment: fixed;background-position: center;">
