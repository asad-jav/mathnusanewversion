                                            ...
                                            @else 
                                                <div class="form-group dropdown">
                                                      <div class="btn-group" role="group">
                                                        <button id="btnGroupDrop1" type="button" class="btn btn-secondary  dropdown-toggle-split dropdown-toggle lecture-{{ $lecture->id }}" style="display: @if($lecture->state == 0) none @endif" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                        Join Lecture
                                                        </button>
