...
<html class="light">
	<head>
		...
		<link rel="apple-touch-icon" href="{{ asset('backend/app-assets/images/logo/t-logo.png')}}">
		...
		<!-- Vendor CSS -->
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/bootstrap/css/bootstrap.min.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/fontawesome-free/css/all.min.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/animate/animate.min.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/simple-line-icons/css/simple-line-icons.min.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/owl.carousel/assets/owl.carousel.min.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/owl.carousel/assets/owl.theme.default.min.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/magnific-popup/magnific-popup.min.css')}}">

		<!-- Theme CSS -->
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/css/theme.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/css/theme-elements.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/css/theme-blog.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/css/theme-shop.css')}}">

		<!-- Current Page CSS -->
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/rs-plugin/css/settings.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/rs-plugin/css/layers.css')}}">
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/vendor/rs-plugin/css/navigation.css')}}">
		
		<!-- Demo CSS -->
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/css/demos/demo-digital-agency-2.css')}}">

		<!-- Skin CSS -->
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/css/skins/skin-digital-agency-2.css')}}"> 

		<!-- Theme Custom CSS -->
		<link rel="stylesheet" href="{{ asset('frontend/landing-page/css/custom.css')}}">
		<!-- Demo CSS -->
		...
		<!-- Head Libs -->
		<script src="{{ asset('frontend/landing-page/vendor/modernizr/modernizr.min.js')}}"></script>
		@yield('css')
	</head>
	<body data-spy="scroll" data-target="#mainNav" data-offset="50">
									...
									<div class="  mb-5 appear-animation animated fadeIn appear-animation-visible" data-appear-animation="fadeIn" data-appear-animation-delay="600" data-appear-animation-duration="750" style="animation-delay: 1200ms;">
										<div class="border-width-10 border-color-light clearfix border border-radius">
											<video class="float-left" width="100%" height="100%" autoplay="" muted="" loop="">
													<source src="{{ asset('frontend/landing-page/video/Outro.mp4')}}" type="video/mp4">
											</video>
										</div>
									</div>
								</div>
		...
		<!-- Vendor -->
		<script src="{{ asset('frontend/landing-page/vendor/jquery/jquery.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/jquery.appear/jquery.appear.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/jquery.easing/jquery.easing.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/jquery.cookie/jquery.cookie.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/popper/umd/popper.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/bootstrap/js/bootstrap.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/common/common.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/jquery.validation/jquery.validate.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/jquery.easy-pie-chart/jquery.easypiechart.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/jquery.gmap/jquery.gmap.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/jquery.lazyload/jquery.lazyload.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/isotope/jquery.isotope.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/owl.carousel/owl.carousel.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/magnific-popup/jquery.magnific-popup.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/vide/jquery.vide.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/vivus/vivus.min.js')}}"></script>
		
		<!-- Theme Base, Components and Settings -->
		<script src="{{ asset('frontend/landing-page/js/theme.js')}}"></script>
		
		<!-- Current Page Vendor and Views -->
		<script src="{{ asset('frontend/landing-page/vendor/rs-plugin/js/jquery.themepunch.tools.min.js')}}"></script>
		<script src="{{ asset('frontend/landing-page/vendor/rs-plugin/js/jquery.themepunch.revolution.min.js')}}"></script>

		<!-- Current Page Vendor and Views -->
		<script src="{{ asset('frontend/landing-page/js/views/view.contact.js')}}"></script>

		<!-- Demo -->
		<script src="{{ asset('frontend/landing-page/js/demos/demo-digital-agency-2.js')}}"></script>

		<!-- Theme Custom -->
		<script src="{{ asset('frontend/landing-page/js/custom.js')}}"></script>
		
		<!-- Theme Initialization Files -->
		<script src="{{ asset('frontend/landing-page/js/theme.init.js')}}"></script>
