...
@section('css')
<link rel="stylesheet" href="{{ asset('landing-page/css/demos/demo-hotel-allCourses.css') }}">
<link rel="stylesheet" href="{{ asset('landing-page/css/skins/skin-hotel-allCourses.css') }}"> 
<style>
            ...
            <div class="row mt-5">
                <div class="col">
                    <ul class="breadcrumb breadcrumb-light custom-title-with-icon-primary d-block">
                        ...
                        <li><a href="{{route('dashboard.packages')}}">Packages</a></li>
                        <li class="active">Courses</li>
                    </ul>
                    <h1 class="custom-text-10 font-weight-bolder mt-3">{{ $package->title }}</h1>
                </div>
            </div>
        </div>
    </section>
                ...
                <div class="col-sm-12 col-md-6 col-lg-12 cour-cus-us p-0 cus-card-cours mt-4 overflow-hidden">
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-3 col-xl-3 p-0">
                        <span class="thumb-info-side-image-wrapper">
                            <img alt="" class="img-fluid w-100 h-100"  src="{{ asset('courses_images/'.$course->image) }}">
                        </span>
                    </div>
                    <div class="col-sm-12 col-md-12 col-lg-7 pt-2">
                        <a href="{{ route('dashboard.course.topics', $course->id) }}">
                        ...
                        <ul class="row px-3 mb-2">
                            ...
                            <li style="padding-right:25px">{{ $course->topics->count() }} Topics</li>
                            {{-- <li>{{ $course->grade }} Grade level</li> --}}
                        </ul>
                    </div>
